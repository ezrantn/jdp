...
import MementoPattern.Shapes.Shape;
...
import MementoPattern.Commands.ColorCommand;
import MementoPattern.Commands.MoveCommand;
...
public class Canvas extends java.awt.Canvas {
    ...
    private void createFrame() {
        ...
        contentPanel.add(new JLabel("Right click to change the color."), BorderLayout.PAGE_END);
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (target != null) {
                    editor.execute(new ColorCommand(editor, new Color((int) (Math.random() * 0x1000_000))));
                    repaint();
                }
            }
        };
